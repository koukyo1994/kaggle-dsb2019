...
def past_summary_features(
    ...
    n_unique_cols = [
        ...
        "event_code", "event_cound", "title", "world", "date",
        "hour", "dayofweek", "title_event_code"
    ]

    sum_cols = [
        "title_event_code", "title", "event_code", "world", "type"]
    sum_values = set()
    for c in sum_cols:
        sum_values = sum_values | set()
